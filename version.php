...
$plugin->version = 2016050200; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '2.0 (Build: 2016050200)'; // visible version - must match iclicker_service constant
